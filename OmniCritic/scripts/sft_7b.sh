...
torchrun --nproc_per_node=4 /data/yiwei.ru/omniR1-sft-master/ms-swift-main/swift/cli/sft.py \
  --do_train \
  --model /data/yiwei.ru/modelscope_7B/Qwen/Qwen2.5-Omni-7B \
  ...
  --deepspeed zero2 \
  --gradient_checkpointing True 2>&1 | tee /data/yiwei.ru/omniR1-sft-master/OmniCritic/logs/log_file_7b.txt
